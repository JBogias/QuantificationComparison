...
This was made in the `kmer_analysis.Rmd` markdown
```{r whole_cor_df, eval=FALSE}
whole_cor <- cor_df %>%
  dplyr::left_join(gene_txp_anno,
                   by = "transcript_id")

whole_cor %>% write_csv(here("data/cor_dfs/whole_cor.csv"))
```

```{r}
cor_df <- read_csv(here("data/cor_dfs/whole_cor.csv"))
```
...
lowcor_ensdb %>% write_csv(here("data/cor_dfs/lowcor_ensdb.csv"))
...
highcor_ensdb %>% write_csv(here("data/cor_dfs/highcor_ensdb.csv"))

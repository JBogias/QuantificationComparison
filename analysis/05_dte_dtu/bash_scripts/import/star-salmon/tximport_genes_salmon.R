...
cts %>%
   ...
   as_tibble() %>%
   write_csv("/hpcfs/users/a1666761/290921_trophoblast_dtu/data/import/STAR_salmon/cts_genes_star_salmon.csv.gz")

write_rds(transCounts_sa,
          "/hpcfs/users/a1666761/290921_trophoblast_dtu/data/import/STAR_salmon/tximport_genes_star_salmon.rds")

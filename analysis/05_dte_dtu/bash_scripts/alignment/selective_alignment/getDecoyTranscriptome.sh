...
genomefile=${refs}/ref_genomes/Homo_sapiens.GRCh38.dna.primary_assembly.fa
gtffile=${refs}/ref_annotations/Homo_sapiens.GRCh38.103.gtf
txpfile=${refs}/ref_transcriptomes/Homo_sapiens.GRCh38.transcriptome.fa
outfolder=${refs}/ref_transcriptomes/GRCh38_decoy_global

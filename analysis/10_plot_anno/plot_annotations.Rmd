...
## Joined Data for Correlation dataframe
...
Turn into function
Here we check to see the counts of the highly variable genes across all samples between methods
```{r}
star_dtelist %>%
  cpm(log = TRUE) %>% 
  as.data.frame() %>% 
...
Now look at the annotations of the highly variable genes
```{r}
